...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StudyEnglishByImage",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19StudyEnglishByImage11AppDelegate")
...
SWIFT_CLASS("_TtC19StudyEnglishByImage6Helper")
...
SWIFT_CLASS("_TtC19StudyEnglishByImage14ViewController")
...
- (void)viewDidLoad;
- (IBAction)click_Camera_Btn:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC19StudyEnglishByImage26TutorialCollectionViewCell")
...
SWIFT_CLASS("_TtC19StudyEnglishByImage22TutorialViewController")
...
- (void)viewDidLoad;
- (IBAction)click_back_btn:(UIButton * _Nonnull)sender;
- (IBAction)click_next_btn:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface TutorialViewController (SWIFT_EXTENSION(StudyEnglishByImage)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@interface ViewController (SWIFT_EXTENSION(StudyEnglishByImage)) <AVCapturePhotoCaptureDelegate>
